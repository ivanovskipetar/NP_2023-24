...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
         ...
         */
        return ZonedDateTime.of(LocalDateTime.of(2015, 7, 10, 2, 14, 25), ZoneId.of("Asia/Tokyo"));
    }
    ...
    static ZonedDateTime toPST() {
         ...
         */
        return ZonedDateTime.of(ldt.toLocalDate(), ldt.toLocalTime(), ZoneId.of("America/Los_Angeles"));
    }
